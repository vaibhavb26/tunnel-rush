function initPentagon1(gl, z_cord) {
    ...
    var positions = [
      0, 0, z_cord,
      r*(Math.cos(Math.PI/10)), r*(Math.sin(Math.PI/10)), z_cord,
      ...
      0, 0, z_cord,
      r*(Math.cos(9*Math.PI/8)), r*(Math.sin(9*Math.PI/8)), z_cord,
      r*(Math.cos(11*Math.PI/10)), r*(Math.sin(11*Math.PI/10)), z_cord,
...
function initPentagon2(gl, z_cord) {
  ...
  // Draw the scene.
  //
  function drawPentagon(gl, programInfo, buffers, texture, deltaTime, i, j) {
    ...
    mat4.rotate(modelViewMatrix2,  // destination matrix
                ...
                obs_rot[j] * .7,// amount to rotate in radians
  ...
  function drawPentagon1(gl, programInfo, buffers, texture, deltaTime, i, j) {
    var modelViewMatrix2, projectionMatrix2;
